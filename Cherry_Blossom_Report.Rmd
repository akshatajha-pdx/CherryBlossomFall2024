...
With the help of our client we were able to scrape around 400,000 observations from the Cherry Blossom Race Data website into a R dataframe. Using this gave us a lot of data to analyze for trends
...
>>>>>>> cb4d9f4b7c2750b059bad340d913bd8f595e19c0
...
Dat_Comb <- Dat_Comb %>%
  filter(!(Year == 2014 & Name == "Corinne Merriman" & Pace == "3:41"))
...
>>>>>>> 958382deb3cf437ac1f773b94278f82011540691
dates <- data.frame(
  year = 1973:2024,
...
```{r}
<<<<<<< HEAD
avg_per_year <- Dat_Comb.full %>% filter(Year != 2015) %>%
  group_by(Year) %>%
  summarise(
...
<<<<<<< HEAD
>>>>>>> 5ab7321de09657b0dc5edf50b79c9cead803359b
=======
```{r}
