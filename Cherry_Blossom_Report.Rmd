...
```{r}
library(readr)
weather <- read_csv("C:\\Users\\azuellig\\Downloads\\weatherdat.csv",show_col_types = FALSE)
...
# Assuming the summarized data is stored in avg_prcp_per_year
